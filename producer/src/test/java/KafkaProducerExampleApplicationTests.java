import com.eviatar.producer.SpringBootProducerApplication;
...
@SpringBootTest(classes = SpringBootProducerApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@Testcontainers
public class KafkaProducerExampleApplicationTests {
    ...
    public void testSendEventsToTopic() throws InterruptedException {
        wikimediaProducer.sendStringMessageToTopic("hi this is the first message");
